/**
 * guessture library from https://github.com/jdm/bevy_guessture that implements the $1 algorithm.
 * Slightly modified to suit our usecase.
 */
...
impl Path2D {
    pub fn new(points: Vec<Point2D<PathCoord>>) -> Path2D {
        Path2D { points }
    }
...
pub fn find_matching_template<'a, 'b>(
    ...
    let candidate = match Template::new("".to_owned(), path.clone()) {
